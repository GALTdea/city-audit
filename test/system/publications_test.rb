...
class PublicationsTest < ApplicationSystemTestCase
  ...
  test "creating a Publication" do
    ...
    fill_in "Journalist", with: @publication.journalist
    fill_in "Likes", with: @publication.likes
    fill_in "Link", with: @publication.link
    fill_in "Publisher", with: @publication.publisher
    fill_in "Rating", with: @publication.rating
    fill_in "Resume", with: @publication.resume

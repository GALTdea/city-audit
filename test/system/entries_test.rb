...
class EntriesTest < ApplicationSystemTestCase
  ...
  test "creating a Entry" do
    ...
    fill_in "City", with: @entry.city
    fill_in "County", with: @entry.county
    fill_in "Likes", with: @entry.likes
    fill_in "Link", with: @entry.link
    fill_in "Rating", with: @entry.rating
    fill_in "Resume", with: @entry.resume
    fill_in "State", with: @entry.state
